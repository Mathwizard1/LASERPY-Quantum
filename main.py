...
modulation_bits = [0, 1, 0, 1, 0, 1, 1, 1, 0, 0, 1]
dt = 1e-12
t_unit = 1e-9
t_final = len(modulation_bits)
#sampling_rate = 2 * dt
...
mModulation = master_Modulation_signal("mModulation", t_unit)
...
sBase = slave_Base_signal("sBase", t_unit)
